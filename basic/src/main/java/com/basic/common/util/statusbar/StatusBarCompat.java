package com.basic.common.util.statusbar;
...
public class StatusBarCompat {
    ...
    public static void changeToLightNavigationBar(@NonNull Activity activity) {
    ...
    public static void cancelLightNavigationBar(@NonNull Activity activity) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            return;
        }
        Window window = activity.getWindow();
